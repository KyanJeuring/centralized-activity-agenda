...
const formattedDate = computed(() => {
  ...
  return new Date(event.value.date).toLocaleDateString("nl-NL", {
    weekday: "long",
    day: "numeric",
    month: "long",
    year: "numeric",
...
const bannerColour = computed(() => {
  if (!event.value) return fallbackCategoryColor;
  return categoryColors[event.value.category] || fallbackCategoryColor;
});
    ...
    <div class="detail-inner">
      ...
      <div class="info-card">
        ...
        <div class="organiser-info">
          ...
          <div>
            <p class="organiser-name">{{ event.organiser }}</p>
            <p class="organiser-location">{{ event.location }}</p>
            <a :href="event.originalSource" target="_blank" class="visit-link">
              Visit website &nearr;
            </a>
          </div>
        </div>
      ...
      <div class="meta-grid">
        <div class="info-card">
          ...
          <p class="info-sub">{{ event.startTime }} – {{ event.endTime }}</p>
        </div>
        <div class="info-card">
        ...
        <div class="info-card full-width">
          ...
          <a :href="event.originalSource" target="_blank" class="source-link">
            View on Hub Website
          </a>
        </div>
      </div>
